...
@Component({
  selector: 'app-chequeclasse',
  templateUrl: './chequeclasse.component.html',
  styleUrls: ['./chequeclasse.component.css']
})
export class ChequeclasseComponent implements OnInit {
  ...
  ShowDotations() {
    this.allDotation = this.tblService.GetClasseCheque();
  }

  //Delete Dotation
  onDelete(Id) {
    if (confirm('Are you sure to delete this record ?')) {
      this.tblService.DeleteClasseCheque(Id)
        .subscribe(res => {
          this.ShowDotations();
          this.resetForm();
  ...
  updateRecord(form: NgForm) {
    this.tblService.EditClasseCheque().subscribe(
      res => {
        this.resetForm(form);
  ...
  insertRecord(form: NgForm) {
    this.tblService.PostClasseCheque().subscribe(
      res => {
        this.resetForm(form);
