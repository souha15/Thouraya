...
@Component({
  selector: 'app-cheque-retrait-edit',
  templateUrl: './cheque-retrait-edit.component.html',
  styleUrls: ['./cheque-retrait-edit.component.css']
})
export class ChequeRetraitEditComponent implements OnInit {

  constructor(private tblService: TypeDonsRetraitService,
