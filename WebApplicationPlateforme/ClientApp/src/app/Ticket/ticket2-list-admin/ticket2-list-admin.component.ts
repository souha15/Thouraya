...
@Component({
  selector: 'app-ticket2-list-admin',
  templateUrl: './ticket2-list-admin.component.html',
  styleUrls: ['./ticket2-list-admin.component.css']
})
export class Ticket2ListAdminComponent implements OnInit {
  ...
  getTicketLis() {
    this.ticketService.ListTicket2().subscribe(res => {
      this.TicList2 = res;
      this.TicList = this.TicList2.filter(item => item.idadmin == this.idadmin)
