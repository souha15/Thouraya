...
@Component({
  selector: 'app-type-activitee-immigration',
  templateUrl: './type-activitee-immigration.component.html',
  styleUrls: ['./type-activitee-immigration.component.css']
})
export class TypeActiviteeImmigrationComponent implements OnInit {
  ...
  ShowDotations() {
    this.allDotation = this.tblService.GetI();
  }

  //Delete Dotation
  onDelete(Id) {
    if (confirm('Are you sure to delete this record ?')) {
      this.tblService.DeleteI(Id)
        .subscribe(res => {
          this.ShowDotations();
          this.resetForm();
  ...
  updateRecord(form: NgForm) {
    this.tblService.EditI().subscribe(
      res => {
        this.resetForm(form);
  ...
  insertRecord(form: NgForm) {
    this.tblService.PostI().subscribe(
      res => {
        this.resetForm(form);
