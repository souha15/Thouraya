...
@Component({
  selector: 'app-type-activitee-dawaa',
  templateUrl: './type-activitee-dawaa.component.html',
  styleUrls: ['./type-activitee-dawaa.component.css']
})
export class TypeActiviteeDawaaComponent implements OnInit {
  ...
  ShowDotations() {
    this.allDotation = this.tblService.GetD();
  }

  //Delete Dotation
  onDelete(Id) {
    if (confirm('Are you sure to delete this record ?')) {
      this.tblService.DeleteD(Id)
        .subscribe(res => {
          this.ShowDotations();
          this.resetForm();
