...
@Component({
  selector: 'app-type-activite-for-womens',
  templateUrl: './type-activite-for-womens.component.html',
  styleUrls: ['./type-activite-for-womens.component.css']
})
export class TypeActiviteForWomensComponent implements OnInit {
