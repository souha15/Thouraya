...
@Component({
  selector: 'app-activite-dawa-elec-add',
  templateUrl: './activite-dawa-elec-add.component.html',
  styleUrls: ['./activite-dawa-elec-add.component.css']
})
export class ActiviteDawaElecAddComponent implements OnInit {
  ...
  getActiviteList() {
    this.typeService.GetDE().subscribe(res => {
      this.typeList = res;
    })
  }
