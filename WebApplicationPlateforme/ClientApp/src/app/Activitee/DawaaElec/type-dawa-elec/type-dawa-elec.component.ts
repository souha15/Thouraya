...
@Component({
  selector: 'app-type-dawa-elec',
  templateUrl: './type-dawa-elec.component.html',
  styleUrls: ['./type-dawa-elec.component.css']
})
export class TypeDawaElecComponent implements OnInit {
  ...
  ShowDotations() {
    this.allDotation = this.tblService.GetDE();
  }

  //Delete Dotation
  onDelete(Id) {
    if (confirm('Are you sure to delete this record ?')) {
      this.tblService.DeleteDE(Id)
        .subscribe(res => {
          this.ShowDotations();
          this.resetForm();
