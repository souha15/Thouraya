...
@Component({
  selector: 'app-type-activitee-compagne',
  templateUrl: './type-activitee-compagne.component.html',
  styleUrls: ['./type-activitee-compagne.component.css']
})
export class TypeActiviteeCompagneComponent implements OnInit {
  ...
  ShowDotations() {
    this.allDotation = this.tblService.GetC();
  }

  //Delete Dotation
  onDelete(Id) {
    if (confirm('Are you sure to delete this record ?')) {
      this.tblService.DeleteC(Id)
        .subscribe(res => {
          this.ShowDotations();
          this.resetForm();
