...
@Component({
  selector: 'app-activite-compagne-add',
  templateUrl: './activite-compagne-add.component.html',
  styleUrls: ['./activite-compagne-add.component.css']
})
export class ActiviteCompagneAddComponent implements OnInit {
