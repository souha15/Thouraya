...
@Component({
  selector: 'app-subvention-orphelin',
  templateUrl: './subvention-orphelin.component.html',
  styleUrls: ['./subvention-orphelin.component.css']
})
export class SubventionOrphelinComponent implements OnInit {
  ...
  onDelete(Id) {
    if (confirm('Are you sure to delete this record ?')) {
      this.tblService.DeleteTypeSubventions(Id)
        .subscribe(res => {
          this.ShowDotations();
          this.resetForm();
  ...
  updateRecord(form: NgForm) {
    this.tblService.EditTypeSubventions().subscribe(
      res => {
        this.resetForm(form);
  ...
  insertRecord(form: NgForm) {
    this.tblService.PostTypeSubventions().subscribe(
      res => {
        this.resetForm(form);
