...
@Component({
  selector: 'app-talent-orphelin',
  templateUrl: './talent-orphelin.component.html',
  styleUrls: ['./talent-orphelin.component.css']
})
export class TalentOrphelinComponent implements OnInit {
