...
@Component({
  selector: 'app-classe-c',
  templateUrl: './classe-c.component.html',
  styleUrls: ['./classe-c.component.css']
})
export class ClasseCComponent implements OnInit {
  ...
  ShowDotations() {
    this.allDotation = this.tblService.GetClasseEvs();
  }
  ...
  insertRecord(form: NgForm) {
    this.tblService.PosC().subscribe(
      res => {
        this.resetForm(form);
