...
@Component({
  selector: 'app-recu-nb-date',
  templateUrl: './recu-nb-date.component.html',
  styleUrls: ['./recu-nb-date.component.css']
})
export class RecuNbDateComponent implements OnInit {
