...
@Component({
  selector: 'app-cadeaux-honor-crud',
  templateUrl: './cadeaux-honor-crud.component.html',
  styleUrls: ['./cadeaux-honor-crud.component.css']
})
export class CadeauxHonorCrudComponent implements OnInit {
  ...
  ShowDotations() {
    this.allDotation = this.tblService.GetTypeHonor();
  }

  //Delete Dotation
  onDelete(Id) {
    if (confirm('Are you sure to delete this record ?')) {
      this.tblService.DeleteTypeHonor(Id)
        .subscribe(res => {
          this.ShowDotations();
          this.resetForm();
  ...
  updateRecord(form: NgForm) {
    this.tblService.EditTypeHonor().subscribe(
      res => {
        this.resetForm(form);
  ...
  insertRecord(form: NgForm) {
    this.tblService.PostTypeHonor().subscribe(
      res => {
        this.resetForm(form);
