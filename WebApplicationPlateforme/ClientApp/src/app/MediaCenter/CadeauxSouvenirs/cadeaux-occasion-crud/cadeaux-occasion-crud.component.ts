...
@Component({
  selector: 'app-cadeaux-occasion-crud',
  templateUrl: './cadeaux-occasion-crud.component.html',
  styleUrls: ['./cadeaux-occasion-crud.component.css']
})
export class CadeauxOccasionCrudComponent implements OnInit {
  ...
  ShowDotations() {
    this.allDotation = this.tblService.GetTypeOccasion();
  }

  //Delete Dotation
  onDelete(Id) {
    if (confirm('Are you sure to delete this record ?')) {
      this.tblService.DeleteTypeOccasion(Id)
        .subscribe(res => {
          this.ShowDotations();
          this.resetForm();
  ...
  updateRecord(form: NgForm) {
    this.tblService.EditTypeOccasion().subscribe(
      res => {
        this.resetForm(form);
  ...
  insertRecord(form: NgForm) {
    this.tblService.PostTypeOccasion().subscribe(
      res => {
        this.resetForm(form);
