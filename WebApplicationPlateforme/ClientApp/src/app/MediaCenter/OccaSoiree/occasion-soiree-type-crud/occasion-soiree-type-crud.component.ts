...
@Component({
  selector: 'app-occasion-soiree-type-crud',
  templateUrl: './occasion-soiree-type-crud.component.html',
  styleUrls: ['./occasion-soiree-type-crud.component.css']
})
export class OccasionSoireeTypeCrudComponent implements OnInit {
  ...
  ShowDotations() {
    this.allDotation = this.tblService.GetOccSoi();
  }

  //Delete Dotation
  onDelete(Id) {
    if (confirm('Are you sure to delete this record ?')) {
      this.tblService.DeleteOccSoi(Id)
        .subscribe(res => {
          this.ShowDotations();
          this.resetForm();
  ...
  updateRecord(form: NgForm) {
    this.tblService.EditOccSoi().subscribe(
      res => {
        this.resetForm(form);
  ...
  insertRecord(form: NgForm) {
    this.tblService.PostOccSoi().subscribe(
      res => {
        this.resetForm(form);
