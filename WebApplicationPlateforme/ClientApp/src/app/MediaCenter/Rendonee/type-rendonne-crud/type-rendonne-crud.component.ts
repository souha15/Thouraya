...
@Component({
  selector: 'app-type-rendonne-crud',
  templateUrl: './type-rendonne-crud.component.html',
  styleUrls: ['./type-rendonne-crud.component.css']
})
export class TypeRendonneCrudComponent implements OnInit {
  ...
  ShowDotations() {
    this.allDotation = this.tblService.GetTypeRendo();
  }

  //Delete Dotation
  onDelete(Id) {
    if (confirm('Are you sure to delete this record ?')) {
      this.tblService.DeleteTypeRendo(Id)
        .subscribe(res => {
          this.ShowDotations();
          this.resetForm();
  ...
  updateRecord(form: NgForm) {
    this.tblService.EditTypeRendo().subscribe(
      res => {
        this.resetForm(form);
  ...
  insertRecord(form: NgForm) {
    this.tblService.PostTypeRendo().subscribe(
      res => {
        this.resetForm(form);
