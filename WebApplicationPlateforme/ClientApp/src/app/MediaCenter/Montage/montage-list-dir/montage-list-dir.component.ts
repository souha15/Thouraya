...
@Component({
  selector: 'app-montage-list-dir',
  templateUrl: './montage-list-dir.component.html',
  styleUrls: ['./montage-list-dir.component.css']
})
export class MontageListDirComponent implements OnInit {
