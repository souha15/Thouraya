...
@Component({
  selector: 'app-design-list-etab',
  templateUrl: './design-list-etab.component.html',
  styleUrls: ['./design-list-etab.component.css']
})
export class DesignListEtabComponent implements OnInit {
