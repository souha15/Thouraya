...
@Component({
  selector: 'app-film-list-dir',
  templateUrl: './film-list-dir.component.html',
  styleUrls: ['./film-list-dir.component.css']
})
export class FilmListDirComponent implements OnInit {
