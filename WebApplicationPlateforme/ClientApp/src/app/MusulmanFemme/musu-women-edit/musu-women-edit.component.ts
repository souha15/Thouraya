...
@Component({
  selector: 'app-musu-women-edit',
  templateUrl: './musu-women-edit.component.html',
  styleUrls: ['./musu-women-edit.component.css'],
  providers: [
    { provide: NgbCalendar, useClass: NgbCalendarIslamicUmalqura },
    { provide: NgbDatepickerI18n, useClass: IslamicI18n }
  ]
})
export class MusuWomenEditComponent implements OnInit {
