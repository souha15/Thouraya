...
@Component({
  selector: 'app-gest-ben-menu-chercheur',
  templateUrl: './gest-ben-menu-chercheur.component.html',
  styleUrls: ['./gest-ben-menu-chercheur.component.css']
})
export class GestBenMenuChercheurComponent implements OnInit {
  ...
  onDelete(Id) {
    if (confirm('Are you sure to delete this record ?')) {
      this.benService.DeleteGestBen(Id)
        .subscribe(res => {
          this.getDataBen();
