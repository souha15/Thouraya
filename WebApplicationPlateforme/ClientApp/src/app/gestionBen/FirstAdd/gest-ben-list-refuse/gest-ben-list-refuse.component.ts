...
@Component({
  selector: 'app-gest-ben-list-refuse',
  templateUrl: './gest-ben-list-refuse.component.html',
  styleUrls: ['./gest-ben-list-refuse.component.css']
})
export class GestBenListRefuseComponent implements OnInit {
