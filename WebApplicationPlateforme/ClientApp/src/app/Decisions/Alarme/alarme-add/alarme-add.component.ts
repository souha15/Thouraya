...
@Component({
  selector: 'app-alarme-add',
  templateUrl: './alarme-add.component.html',
  styleUrls: ['./alarme-add.component.css']
})
export class AlarmeAddComponent implements OnInit {
  ...
  add(form: NgForm) {
    ...
    if (form.invalid) {
      ...
      this.dem.typeDecint = 3;
      this.dem.typeDecstr = "قرار تنبيه وانذار"
