...
@Component({
  selector: 'app-decissive-report',
  templateUrl: './decissive-report.component.html',
  styleUrls: ['./decissive-report.component.css']
})
export class DecissiveReportComponent implements OnInit {
