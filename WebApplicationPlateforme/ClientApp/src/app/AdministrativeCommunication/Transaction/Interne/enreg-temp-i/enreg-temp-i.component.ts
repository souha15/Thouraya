...
@Component({
  selector: 'app-enreg-temp-i',
  templateUrl: './enreg-temp-i.component.html',
  styleUrls: ['./enreg-temp-i.component.css']
})
export class EnregTempIComponent implements OnInit {
