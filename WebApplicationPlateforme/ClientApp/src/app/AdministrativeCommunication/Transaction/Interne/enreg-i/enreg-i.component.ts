...
@Component({
  selector: 'app-enreg-i',
  templateUrl: './enreg-i.component.html',
  styleUrls: ['./enreg-i.component.css']
})
export class EnregIComponent implements OnInit {
        ...
        if (this.FiltredList2.length != null)
          ...
          this.FiltredList2.forEach(element => {
            ...
            if (this.ListAffectation.length == 0) {
              ...
              this.transactionService.GetByIdI(id).subscribe(res => {
