...
@Component({
  selector: 'app-enreg-e',
  templateUrl: './enreg-e.component.html',
  styleUrls: ['./enreg-e.component.css']
})
export class EnregEComponent implements OnInit {
  ...
  populateForm(transaction: Transaction) {
    ...
    this.liaisonService.ListE().subscribe(res => {
        ...
        if (this.FiltredList2.length != null)
          ...
          this.FiltredList2.forEach(element => {
            ...
            if (this.ListAffectation.length == 0) {
              ...
              this.transactionService.GetByIdE(id).subscribe(res => {
