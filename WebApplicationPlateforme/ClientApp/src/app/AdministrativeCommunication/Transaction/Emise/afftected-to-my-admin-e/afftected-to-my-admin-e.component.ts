...
@Component({
  selector: 'app-afftected-to-my-admin-e',
  templateUrl: './afftected-to-my-admin-e.component.html',
  styleUrls: ['./afftected-to-my-admin-e.component.css']
})
export class AfftectedToMyAdminEComponent implements OnInit {
