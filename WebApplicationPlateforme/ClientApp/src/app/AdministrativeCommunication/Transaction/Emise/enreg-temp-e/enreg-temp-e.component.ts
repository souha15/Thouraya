...
@Component({
  selector: 'app-enreg-temp-e',
  templateUrl: './enreg-temp-e.component.html',
  styleUrls: ['./enreg-temp-e.component.css']
})
export class EnregTempEComponent implements OnInit {
