...
@Component({
  selector: 'app-rapport-recue',
  templateUrl: './rapport-recue.component.html',
  styleUrls: ['./rapport-recue.component.css']
})
export class RapportRecueComponent implements OnInit {
  ...
  //Listing
  private selectedLink: string = "mine";
