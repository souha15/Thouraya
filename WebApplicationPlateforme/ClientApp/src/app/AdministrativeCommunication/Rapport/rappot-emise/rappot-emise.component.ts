...
@Component({
  selector: 'app-rappot-emise',
  templateUrl: './rappot-emise.component.html',
  styleUrls: ['./rappot-emise.component.css']
})
export class RappotEmiseComponent implements OnInit {
