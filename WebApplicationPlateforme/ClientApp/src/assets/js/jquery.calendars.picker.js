 	...
 	alert('Selected ' + dates);
		...
		regionalOptions: { // Available regional settings, indexed by language/country code
			'': { // Default regional settings - English/US
				...
				prevText: '&lt; السابق', // Prev
				prevStatus: 'عرض الشهر السابق', //Show the previous month
				prevJumpText: '&lt;&lt;',
				prevJumpStatus: 'عرض العام السابق', //Show the previous year
				nextText: 'التالي &gt;', // Next
				nextStatus: 'عرض الشهر التالي', //Show the next month
				nextJumpText: '&gt;&gt;',
				nextJumpStatus: 'عرض العام التالي', // Show the next year
				currentText: 'الحالي', //Current
				currentStatus: 'عرض الشهر الحالي', //Show the current month
				todayText: 'اليوم',	//Today
				todayStatus: 'هذا الشهر',	//Show today\'s month
				clearText: 'مسح', //Clear
